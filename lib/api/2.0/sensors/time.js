...
export class Time {
  ...
  /**
     ...
     */
  getHourFormat() {
    return this._time.getHourFormat();
  }
  ...
  /**
     ...
     */
  getFormatHour() {
    return this._time.getFormatHour();
  }
  ...
  onPerMinute(callback) {
    this._time.onPerMinute(callback);
  }
  ...
  /**
     ...
     */
  getLunarYear() {
    return this._time.getLunarYear();
  }
  ...
  /**
     ...
     */
  getLunarMonth() {
    return this._time.getLunarMonth();
  }
  ...
  /**
     ...
     */
  getLunarFestival() {
    return this._time.getLunarFestival();
  }
  ...
  /**
     ...
     */
  getSolarTerm() {
    return this._time.getSolarTerm();
  }
