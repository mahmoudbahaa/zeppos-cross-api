...
export class Stress {
  #stress
  constructor () { this.#stress = new Strss() }
  ...
  getToday = () => { throw new Error(UNSUPPORTED) }
  getTodayByHour = () => { throw new Error(UNSUPPORTED) }
  getLastWeek = () => { throw new Error(UNSUPPORTED) }
  getLastWeekByHour = () => { throw new Error(UNSUPPORTED) }
}
// #endif
