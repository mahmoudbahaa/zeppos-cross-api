...
export class Sleep {
  constructor() {
    this._sleep = hmSensor.createSensor(hmSensor.id.SLEEP);
  }
   ...
   */
  getStageConstantObj() {
    return this._sleep.getSleepStageModel();
  }
   ...
   */
  getStage() {
    return this._sleep.getSleepStageData();
  }
