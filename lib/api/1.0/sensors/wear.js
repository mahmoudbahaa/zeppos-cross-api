...
export class Wear {
  constructor() {
    this._wear = hmSensor.createSensor(hmSensor.id.WEAR);
  }
  ...
  /**
     ...
     */
  onChange(callback) {
    this._wear.addEventListener(hmSensor.event.CHANGE, callback);
  }
  ...
  /**
     ...
     */
  offChange(callback) {
    this._wear.removeEventListener(hmSensor.event.CHANGE, callback);
  }
}
