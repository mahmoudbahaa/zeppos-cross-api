...
export class HeartRate {
  constructor() {
    this._heart = hmSensor.createSensor(hmSensor.id.HEART);
  }
  ...
  onCurrentChange(callback) {
    this._heart.addEventListener(this._heart.event.CURRENT, callback);
  }
  ...
  offCurrentChange(callback) {
    this._heart.removeEventListener(this._heart.event.CURRENT, callback);
  }
  ...
  onLastChange(callback) {
    this._heart.addEventListener(this._heart.event.LAST, callback);
  }
  ...
  offLastChange(callback) {
    this._heart.removeEventListener(this._heart.event.LAST, callback);
  }
