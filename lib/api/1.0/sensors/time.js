...
import { TIME_HOUR_FORMAT_12, TIME_HOUR_FORMAT_24 } from './_constants';
...
export class Time {
  constructor() {
    this._time = hmSensor.createSensor(hmSensor.id.TIME);
  }
  ...
  /**
     ...
     */
  getHourFormat() {
    return this._time.is24Hour ? TIME_HOUR_FORMAT_24 : TIME_HOUR_FORMAT_12;
  }
  ...
  onPerMinute(callback) {
    this._time.addEventListener(this._time.event.MINUTEEND, callback);
  }
  ...
  /**
     ...
     */
  onPerDay(callback) {
    this._time.addEventListener(this._time.event.DAYCHANGE, callback);
  }
  ...
  /**
     ...
     */
  getFestival() {
    return this._time.solar_festival;
  }
  ...
  /**
     ...
     */
  getLunarFestival() {
    return this._time.lunar_festival;
  }
  ...
  /**
     ...
     */
  getSolarTerm() {
    return this._time.lunar_solar_term;
  }
  ...
  /**
     ...
     */
  getShowFestival() {
    return this._time.getShowFestival();
  }
  ...
  getLunarMonthCalendar() {
    return this._time.getLunarMonthCalendar();
  }
